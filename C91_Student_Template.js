...
function car1_up()
{
	...
	{
		car1Y = car1Y - 10;
		console.log("Quando a seta pra cima é pressionada, x = " + car1X + " | y = " +car1Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_down()
{
	...
	{
		car1Y = car1Y + 10;
		console.log("Quando a seta pra baixo é pressionada, x = " + car1X + " | y = " +car1Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_left()
{
	...
	{
		car1X = car1X - 10;
		console.log("Quando a seta pra esquerda é pressionada, x = " + car1X + " | y = " +car1Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_right()
{
	...
	{
		car1X = car1X +10;
		console.log("Quando a seta pra direita é pressionada, x = " + car1X + " | y = " +car1Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_up()
{
	...
	{
		car2Y = car2Y - 10;
		console.log("Quando a seta pra cima é pressionada, x = " + car2X + " | y = " +car2Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_down()
{
	...
	{
		car2Y = car2Y + 10;
		console.log("Quando a seta pra baixo é pressionada, x = " + car2X + " | y = " +car2Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_left()
{
	...
	{
		car2X = car2X - 10;
		console.log("Quando a seta pra esquerda é pressionada, x = " + car2X + " | y = " +car2Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_right()
{
	...
	{
		car2X = car2X +10;
		console.log("Quando a seta pra direita é pressionada, x = " + car2X + " | y = " +car2Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
